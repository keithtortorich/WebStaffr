...
Per ARCHITECTURE.md's minimal design for the first system slice: a Tenant
is an identifier only. No profile data, settings, or relationships beyond
what other entities reference back to it.
"""
