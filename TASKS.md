...
5. [ ] Decide what's next after Angel: a `/book` endpoint exposing `Angel.book_appointment` over HTTP (currently only reachable in-process), and/or wiring the widget onto an actual generated site.
